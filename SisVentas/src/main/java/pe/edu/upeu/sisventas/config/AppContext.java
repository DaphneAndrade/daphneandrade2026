...
public class AppContext {
    ...
    private void registrarServicios() {
        ...
        registrar(IMarcaService.class,        new MarcaServisimp.MarcaServiceImp(       getBean(MarcaRepository.class)));
        registrar(IProductoService.class,     new ProductoServicesImp(    getBean(ProductoRepository.class)));
        registrar(IUnidadMedidaService.class, new UnidadMedidaServiceImp(getBean(UnidMedidaRepository.class)));
